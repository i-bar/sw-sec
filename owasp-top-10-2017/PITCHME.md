...
@size[1em](Top 10 items are selected and prioritized according to:)

@ul[](false)
* @size[1em](prevalence (based on data\) &)
* @size[1em](exploitability, detectability and impact (based on consensus estimates\).)
@ulend
